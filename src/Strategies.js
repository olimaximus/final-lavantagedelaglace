        ...
        <div className="Strategies">
            <div className="Front-Panel">
                ...
                <div className="videos">
                    <div className='row'>
                        <Link to={"/lavantagedelaglace/video/" + videos[18].id} className="single-video-display">
                            <img src={videos[18]['thumbnail-url']} alt={videos[18].title} />
                            <h4>{videos[18].title}</h4>
                        </Link>
                        <Link to={"/lavantagedelaglace/video/" + videos[19].id} className="single-video-display">
                            <img src={videos[19]['thumbnail-url']} alt={videos[19].title} />
                            <h4>{videos[19].title}</h4>
                        </Link>
                        <Link to={"/lavantagedelaglace/video/" + videos[20].id} className="single-video-display">
                            <img src={videos[20]['thumbnail-url']} alt={videos[20].title} />
                            <h4>{videos[20].title}</h4>
                        </Link>
                    </div>
                    <div className='row'>
                    <Link to={"/lavantagedelaglace/video/" + videos[21].id} className="single-video-display">
                            <img src={videos[21]['thumbnail-url']} alt={videos[21].title} />
                            <h4>{videos[21].title}</h4>
                        </Link>
                        <Link to={"/lavantagedelaglace/video/" + videos[22].id} className="single-video-display">
                            <img src={videos[22]['thumbnail-url']} alt={videos[22].title} />
                            <h4>{videos[22].title}</h4>
                        </Link>
                        <Link to={"/lavantagedelaglace/video/" + videos[23].id} className="single-video-display">
